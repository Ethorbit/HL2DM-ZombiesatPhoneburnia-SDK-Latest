...
ConVar	sk_antlionguard_dmg_charge("sk_antlionguard_dmg_charge", "500");
ConVar	sk_antlionguard_dmg_shove("sk_antlionguard_dmg_shove", "100");
...
ConVar	sk_antlionguard_health("sk_antlionguard_health", "1200");
